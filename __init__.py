...
from hitapply.blueprints.admin import admin_login, admin_logout, user_info, notice_add, notice_del
...
def register_blueprints(app):
    ...
    # POST: 新增公告
    app.register_blueprint(notice_add.notice_add, url_prefix='/api/admin/notice')
